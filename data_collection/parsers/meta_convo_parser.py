...
def parse_meta_convo_ds() -> [str]:
    file_path = os.path.abspath(os.path.join(os.path.dirname(__file__), "..","datasets/meta_convo_ds/CasualConversations_transcriptions(1).json"))
