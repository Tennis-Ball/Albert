...
def parse_meta_convo_ds():
    ...
    percentMarker = re.compile(' % ')
    return [re.sub(percentMarker, ' ', re.sub(extraTagsRegex, '', re.sub(secondSpeakerRegex, 'Spkr2', re.sub(firstSpeakerRegex, 'Spkr1', data)))) for data in transcripts]
